package com.yobotics.planecontrolview;
...
public class PlaneControlView extends View {
    ...
    //activity_controller_joystick_rocker 默认位置 0-center， 1-bottom
    ...
    public void init(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.PlaneControlView, defStyleAttr, 0);
